import cv2
import training.webcv2 as webcv2
import numpy as np
import torch
from data.processes.data_process import MakeICDARData


class SegDetectorVisualizer:

    def __init__(self, vis_num=4, eager_show=False):
        self.vis_num = vis_num
        self.eager_show = eager_show
